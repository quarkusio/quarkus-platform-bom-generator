...
public class GoogleCloudIamReleaseIdDetector implements ReleaseIdDetector {

    @Override
    public ScmRevision detectReleaseId(ScmRevisionResolver releaseResolver, Artifact artifact)
            throws BomDecomposerException {
        if (artifact.getGroupId().equals("com.google.cloud")
                && artifact.getArtifactId().contains("google-iam")) {
            ...
            if (origin.hasUrl() && origin.getUrl().equals("https://github.com/googleapis/sdk-platform-java")) {
                return ScmRevision.version(ScmRepository.ofId("com.google.cloud:google-iam-parent"), artifact.getVersion());
            }
        }
        return null;
    }
