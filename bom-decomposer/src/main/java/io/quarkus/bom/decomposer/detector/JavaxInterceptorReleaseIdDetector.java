    ...
    public ScmRevision detectReleaseId(ReleaseIdResolver releaseResolver, Artifact artifact)
        ...
        if (artifact.getGroupId().equals("javax.interceptor")) {
            ...
            if (releaseId.getRepository().hasUrl()
                    && releaseId.getRepository().getUrl().equals("https://github.com/javaee/javax.interceptor")) {
                return releaseId;
            }
            return ScmRevision.tag(ScmRepository.ofUrl("https://github.com/javaee/javax.interceptor"),
                    releaseId.getValue());
        }
        return null;
    }
